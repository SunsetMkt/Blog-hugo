...
export declare let wasm_pthread_mutex_lock: (mutex: pointer<Mutex>) => int32 | Promise<int32>;
...
export declare let wasm_pthread_cond_wait: (cond: pointer<Cond>, mutex: pointer<Mutex>) => int32 | Promise<int32>;
export declare let wasm_pthread_cond_timedwait: (cond: pointer<Cond>, mutex: pointer<Mutex>, abstime: pointer<Timespec>) => int32 | Promise<int32>;
...
export declare function wasm_pthread_mutex_lock_async(mutex: pointer<Mutex>): Promise<int32>;
export declare function wasm_pthread_cond_wait_async(cond: pointer<Cond>, mutex: pointer<Mutex>): Promise<int32>;
export declare function wasm_pthread_cond_timedwait_async(cond: pointer<Cond>, mutex: pointer<Mutex>, abstime: pointer<Timespec>): Promise<int32>;
