...
For Windows：在`about:config`将`media.wmf.hevc.enabled`设为`1`（在最新版本已默认）。

For Linux：使用[zhaohappy/libmedia 提供的 Web 媒体播放器 Demo](https://zhaohappy.github.io/libmedia/product/player/player.html)作为临时替代方案。
