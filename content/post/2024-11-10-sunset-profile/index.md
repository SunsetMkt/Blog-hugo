...
|   所属团体[^3]   |                                Sunset Edu. & Tech. Group <span class="heimu" title="你知道的太多了">SCP 基金会[^6]</span>                                |
|   个人状态[^3]   |                                                                   活动中（取决于作品）                                                                   |
...
[Sunset](https://github.com/SunsetMkt)[^10]创作的原创角色及其创作的虚拟组织[Sunset Edu. & Tech. Group](https://github.com/Sunset-Edu-Tech-Group)的成员。

[^10]: 需要注意，这里提到的“Sunset”指现实存在的个体，且全文仅此一次。尽管同名，原则上，作者和此角色不可等同看待。

Sunset Edu. & Tech. Group 的主程序员，兼职美工文案宣发。作为作者的下层叙事投影广泛活动在其作品中，是作者最常使用的掩盖身份。

## 人物特点

表面高冷、谈到喜欢的事物就会热情起来的年轻女性人类。有着一头橙色的马尾、黑色的瞳孔、略显空洞的眼神、严肃的黑框眼镜、以及 _“至少不难看”_ 的面孔。

平时不喜欢说话，自称 _“无法理解人类的普遍情感”_ ，但总会在陌生人面前莫名其妙地紧张害羞，也总会在情感波动中失去对自己 _“理性”_ 的控制。<span class="heimu" title="你知道的太多了">~~但是绝对不会承认自己“动情了”。~~</span><span class="heimu" title="你知道的太多了">有时会暗中希望自己是个“阳角”。</span>
...
### Sunset Edu. & Tech. Group

#### 第一版简介

<span class="heimu" title="你知道的太多了">~~成立于某下层叙事、与 SCP 基金会合作，致力于在学园都市内部实行间谍活动并秘密部署大量斯克兰顿现实稳定锚，并以教育和信息技术开发作为前台组织的掩盖工作，Sunset Edu. & Tech. Group 在各个叙事层吸引了大量叙事实体加入，并允许甚至鼓励（相对）上层叙事实体使用此设定。~~</span>

#### 另一个可能的简介

由 Sunset 创建。尽管是 "Group"，事实上只是同好团体，<span class="heimu" title="你知道的太多了">职位名称只是为了让各自的名字显得长一点</span>。
...
Sunset 的女友（？），是在 Sunset Edu. & Tech. Group 建立后第一个加入的人。
...
Sunset 可能使用假名，可能的中文假名包括 Zhao、Lee、Chang、Wang 等，有时也会使用日文假名[^12]。
...
在一次前往被称作 Kivotos 的地区的出差中意外获得了只有在当地范围内才会出现的机械光环。为了让自己看起来更像本地人，Sunset 捡走了路边<span class="heimu" title="你知道的太多了">被子弹打晕的女孩子</span>的胸牌戴在了自己身上。~~为了更好地逃跑，她换上了一双运动鞋。~~
