...
美国制裁压力导致 Google 对华为断供 GMS 是政策结果、华为和相关方的回应是政治表态、华为在 HarmonyOS 4 的宣传中淡化 AOSP 是政治叙事、购买或不购买华为设备有时也是政治选择，因 Google 与 GitHub 受阻导致国内缺乏清晰的开源技术说明是网络政治的衍生现实。在这个特定技术问题的成因上，政治是因、技术是果，假装政治在这个问题上不存在是不现实的。认为技术和政治无关的观点合情但不合理，尽管如此，已通过折叠文本的方式作为缓解措施。
